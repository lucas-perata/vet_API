...
namespace API.Interfaces
{
    public interface ISpendingInterface
    {
        ...
        Task<PagedList<Spending>> GetSpendingsForOwnerMonthly(string ownerId, UserParams userParams);
        ...
        Task<PagedList<SpendingDto>> GetSpendingsForCategory(string ownerId, SpendingCategory category, UserParams userParams);
        Task<PagedList<SpendingDto>> GetSpendingsForDateRange(string ownerId, DateTime startDate, DateTime endDate, UserParams userParams);
    }
}